...
assert.ok(
  indexHtml.includes('./src/client/app.js?v=20260530-markdown-parse-cleanup'),
...
for (const [file, activeLabel] of pages) {
  ...
  assert.ok(html.includes("./styles.css?v=20260530-light-sidebar"), `${file} should load the cache-busted command center stylesheet.`);
