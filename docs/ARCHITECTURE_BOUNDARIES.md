...
| RAG Q&A | `POST /api/deepseek-rag`, `/api/deepseek-rag-jobs` | `server.mjs` | `src/server/deepseek-rag-service.mjs`, `src/server/generation-job-service.mjs`, `src/server/ai-quality.mjs` |
